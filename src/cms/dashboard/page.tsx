...
import { Folder, FileText, MessageSquare, CalendarCheck, Users, TrendingUp } from "lucide-react";
    ...
    <div className="rounded-xl border border-border bg-surface p-6 transition-all hover:shadow-luxury">
      <div className="flex items-start justify-between">
        <div>
          ...
          <Heading as="h2" size="2xl" weight="light" className="mt-2">{value}</Heading>
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <StatCard icon={Folder} label="Total Projects" value="0" color="bg-blue-50" />
